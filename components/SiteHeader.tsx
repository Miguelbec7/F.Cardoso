    ...
    <header className="sticky top-0 z-40 border-b border-line bg-canvas/85 backdrop-blur-md">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 py-3.5">
        <Link href="/" className="flex items-center gap-2.5">
          <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-linear-to-br from-brand-bright to-brand text-base font-extrabold text-white">
            F
          </span>
          <span className="leading-tight">
            <strong className="block text-sm font-extrabold tracking-tight">F. CARDOSO</strong>
            <span className="block text-[0.62rem] uppercase tracking-[0.14em] text-muted">Automóveis</span>
          </span>
        </Link>
